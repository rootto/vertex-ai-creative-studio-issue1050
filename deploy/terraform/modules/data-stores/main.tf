...
locals {
  firestore_indexes = {
    ...
    # get_media_for_page_v4: user_email + media_type + order_by timestamp
    genmedia_user_email_media_type_timestamp = {
      fields = [
        { field_path = "user_email", order = "ASCENDING" },
        { field_path = "media_type", order = "ASCENDING" },
        { field_path = "timestamp", order = "DESCENDING" },
    ...
    # get_media_for_page_v4: team_id + media_type + order_by timestamp
    genmedia_team_id_media_type_timestamp = {
      fields = [
        { field_path = "team_id", order = "ASCENDING" },
        { field_path = "media_type", order = "ASCENDING" },
        { field_path = "timestamp", order = "DESCENDING" },
      ]
    }
    # get_media_for_page_v4: team_id + order_by timestamp
    genmedia_team_id_timestamp = {
      fields = [
        { field_path = "team_id", order = "ASCENDING" },
        { field_path = "timestamp", order = "DESCENDING" },
      ]
