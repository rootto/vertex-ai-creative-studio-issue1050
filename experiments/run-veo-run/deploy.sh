...
gcloud beta run deploy $SERVICE_NAME \
  ...
  --region us-central1 \
  --set-env-vars GOOGLE_CLOUD_PROJECT=${GOOGLE_CLOUD_PROJECT},VEO_BUCKET=${VEO_BUCKET},GEMINI_MODEL=${GEMINI_MODEL},GEMINI_MODEL_LOCATION=${GEMINI_MODEL_LOCATION:-global},VEO_MODEL=${VEO_MODEL},VEO_LOCATION=${VEO_LOCATION:-us-central1},GOOGLE_CLOUD_LOCATION=${GOOGLE_CLOUD_LOCATION:-us-central1} \
  --iap \
